create table star_demo
(
    id          bigint       not null
        primary key,
    star_name   varchar(10)  null,
    sex         varchar(2)   null,
    age         int          null,
